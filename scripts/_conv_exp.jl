...
# For running one particular simulation uncomment this part and comment the other one
dict = Dict(:time_max=>1e4,:conv_max=>200,:file_name=>"covtype", :nInducing=>50,:nMinibatch=>10,:likelihood=>:Logistic, :doCAVI=>!true,:doGD=>true,:doNGD=>!true)
@show f = ARGS[1]
dict = load(f)
try
